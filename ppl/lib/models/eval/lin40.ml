...
let lin obs_points ax ay () =
	...
	let* m20 = normal 0.0 3.0 in
	let* m21 = normal 0.0 3.0 in
	let* m22 = normal 0.0 3.0 in
	let* m23 = normal 0.0 3.0 in
	let* m24 = normal 0.0 3.0 in
	let* m25 = normal 0.0 3.0 in
	let* m26 = normal 0.0 3.0 in
	let* m27 = normal 0.0 3.0 in
	let* m28 = normal 0.0 3.0 in
	let* m29 = normal 0.0 3.0 in
	let* m30 = normal 0.0 3.0 in
	let* m31 = normal 0.0 3.0 in
	let* m32 = normal 0.0 3.0 in
	let* m33 = normal 0.0 3.0 in
	let* m34 = normal 0.0 3.0 in
	let* m35 = normal 0.0 3.0 in
	let* m36 = normal 0.0 3.0 in
	let* m37 = normal 0.0 3.0 in
	let* m38 = normal 0.0 3.0 in
	let* m39 = normal 0.0 3.0 in
	let* c = normal 1. 5. in 


	for i = 0 to (obs_points-1) do 
		observe (mk ay.(i) -. c -. m0*.mk ax.(i).(0)-. m1*.mk ax.(i).(1)-. m2*.mk ax.(i).(2)-. m3*.mk ax.(i).(3)-. m4*.mk ax.(i).(4)-. m5*.mk ax.(i).(5)-. m6*.mk ax.(i).(6)-. m7*.mk ax.(i).(7)-. m8*.mk ax.(i).(8)-. m9*.mk ax.(i).(9)-. m10*.mk ax.(i).(10)-. m11*.mk ax.(i).(11)-. m12*.mk ax.(i).(12)-. m13*.mk ax.(i).(13)-. m14*.mk ax.(i).(14)-. m15*.mk ax.(i).(15)-. m16*.mk ax.(i).(16)-. m17*.mk ax.(i).(17)-. m18*.mk ax.(i).(18)-. m19*.mk ax.(i).(19)-. m20*.mk ax.(i).(20)-. m21*.mk ax.(i).(21)-. m22*.mk ax.(i).(22)-. m23*.mk ax.(i).(23)-. m24*.mk ax.(i).(24)-. m25*.mk ax.(i).(25)-. m26*.mk ax.(i).(26)-. m27*.mk ax.(i).(27)-. m28*.mk ax.(i).(28)-. m29*.mk ax.(i).(29)-. m30*.mk ax.(i).(30)-. m31*.mk ax.(i).(31)-. m32*.mk ax.(i).(32)-. m33*.mk ax.(i).(33)-. m34*.mk ax.(i).(34)-. m35*.mk ax.(i).(35)-. m36*.mk ax.(i).(36)-. m37*.mk ax.(i).(37)-. m38*.mk ax.(i).(38)-. m39*.mk ax.(i).(39)) (logpdf Primitive.(normal 0. 3.))
	done ;
	m0
