...
let lin obs_points ax ay () =
	...
	for i = 0 to (obs_points-1) do 
		observe (mk ay.(i) -. c -. m0*.mk ax.(i).(0)-. m1*.mk ax.(i).(1)-. m2*.mk ax.(i).(2)-. m3*.mk ax.(i).(3)-. m4*.mk ax.(i).(4)-. m5*.mk ax.(i).(5)-. m6*.mk ax.(i).(6)-. m7*.mk ax.(i).(7)-. m8*.mk ax.(i).(8)-. m9*.mk ax.(i).(9)) (logpdf Primitive.(normal 0. 3.))
	done ;
	m0
